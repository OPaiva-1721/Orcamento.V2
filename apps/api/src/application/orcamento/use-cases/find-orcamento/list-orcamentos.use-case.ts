...
import { OrcamentoFilters, PaginatedResponse, Orcamento } from '@orcamento/shared-types';
...
export class ListOrcamentosUseCase {
  ...
  async execute(filters: OrcamentoFilters): Promise<PaginatedResponse<Orcamento>> {
